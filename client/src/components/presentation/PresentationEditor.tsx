        ...
        <header className="bg-white border-b border-gray-200 px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-xl text-gray-900">Designer</span>
            </div>
          ...
          <div className="flex-1 max-w-md mx-4">
            <Input
              ...
              className="text-center border-none shadow-none text-lg font-medium"
        ...
        <div className="flex-1 flex">
          ...
          <div className="flex-1 flex flex-col">
            ...
            <div className="flex-1 bg-gray-100 p-8 flex items-center justify-center">
              <Card className="w-full max-w-4xl aspect-video shadow-2xl">
                <CardContent className="p-0 h-full bg-gradient-to-br from-purple-500 to-pink-500 rounded-lg flex items-center justify-center">
                  <div className="text-center text-white">
                    <FileText className="h-16 w-16 mx-auto mb-4 opacity-50" />
                    <h2 className="text-2xl font-bold mb-2">Your Presentation</h2>
                    <p className="text-purple-100">Click to start editing</p>
                  </div>
                </CardContent>
              </Card>
            </div>
